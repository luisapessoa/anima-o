...
const PRELOAD = ['assets/real/logo-white.png', 'assets/real/logo-navy.png', 'assets/real/car-tera-12r.png', 'assets/real/car-virtus-12.png', 'assets/real/ic12-family.png', 'assets/real/ic12-car.png', 'assets/real/ic12-shield.png'];
function ease(lt, delay, d) {
  return E.easeOutCubic(clamp((lt - delay) / (d || 0.6), 0, 1));
}
function easeIO(lt, delay, d) {
...
const Lines = ({
  ...
  px,
  align
}) => /*#__PURE__*/React.createElement(React.Fragment, null, (lines || []).map((ln, i) => /*#__PURE__*/React.createElement("div", {
  key: i,
  style: {
    ...rise(lt, delay + i * (step || 0.09), px == null ? 22 : px),
    color,
    fontWeight: weight,
    fontSize: size,
    lineHeight: lh + 'px',
...
function BgVideo({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(VideoSprite, {
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: `rgba(0,0,0,${overlay == null ? 0.4 : overlay})`
    }
  }));
}
...
function StatBox() {
  ...
  const DY = 120,
    ...
    bottom = 1189 + DY,
    lw = 3;
  const a = easeIO(lt, 0.2, 0.5),
    b = easeIO(lt, 0.62, 0.45),
    c = easeIO(lt, 0.99, 0.5);
  const car = pop(lt, 1.0, 1.0),
    carIn = ease(lt, 1.0, 0.45);
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...shell,
      background: SKY
    ...
    src: "assets/real/car-tera-12r.png",
    alt: "Tera",
    style: {
      position: 'absolute',
      left: 106,
...
function Growth() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 3,
      background: SKY,
      transform: `scaleX(${easeIO(lt, 0.25, 0.6)})`,
      transformOrigin: 'left'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
...
function Priorities() {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Lines, {
    lines: sc.head,
    lt: lt,
    delay: 0.3,
    step: 0.1,
...
function Pitch() {
  ...
  const lt = s.localTime;
  const sc = s.scene;
  const car = pop(lt, 0.2, 1.0),
    carIn = ease(lt, 0.2, 0.45);
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...shell,
      background: SKY
    ...
    src: "assets/real/car-virtus-12.png",
    alt: "Virtus",
    style: {
      position: 'absolute',
      left: 134,
    ...
    style: {
      ...
      height: 3,
      background: NAVY,
      transform: `scaleX(${easeIO(lt, 1.55, 0.6)})`,
      transformOrigin: 'left'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
...
function Cta() {
  ...
  const gapL = 205,
    ...
    btnL = 279,
    btnR = 801;
  const v = easeIO(lt, 0.2, 0.7),
    h = easeIO(lt, 0.7, 0.5);
  const btn = ease(lt, 1.9, 0.5),
    btnT = ease(lt, 2.1, 0.45);
  const seg = (x0, x1, y, origin) => /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      left: x0,
      top: y,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }), seg(L, gapL, T, 'left'), seg(gapR, R + lw, T, 'right'), seg(L, btnL, B, 'left'), seg(btnR, R + lw, B, 'right'), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      left: 0,
      right: 0,
    ...
    style: {
      ...
      whiteSpace: 'nowrap',
      opacity: btnT,
      transform: `translateY(${(1 - btnT) * 24}px)`
    }
  }, sc.cta)));
}
const LAYOUTS = {
...
function RealVideo4() {
  ...
  const children = {};
  scenes.forEach(sc => {
    children[sc.name] = LAYOUTS[sc.layout] || Intro;
  });

...
function HeroCount() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    op: 0.62,
    overlay: dimOverlay
  }), RUNTIME2.showLogo ? /*#__PURE__*/React.createElement(Logo, {
    lt: lt
...
function TealScreen() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, (sc.num || '')[0]), (sc.num || '').slice(1))), RUNTIME2.showLogo ? /*#__PURE__*/React.createElement(Logo, {
    lt: lt
  }) : null, /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
    ...
    const items = blocks.map((blk, bi) => {
      const start = d;
      d += blk.lines.length * 0.08 + 0.28;
      const inner = /*#__PURE__*/React.createElement(Lines, {
        list: blk.lines,
        lt: lt,
        delay: start,
        step: 0.08,
  ...
  })(), sc.car ? /*#__PURE__*/React.createElement("img", {
    src: "assets/vw-virtus.webp",
    alt: "",
    style: {
      position: 'absolute',
      left: '50%',
      ...
      width: 1030,
      height: 'auto',
      transform: `translateX(-50%) translateY(${(1 - ease(lt, 0.9, 0.8)) * 26}px)`,
      opacity: ease(lt, 0.9, 0.8),
      zIndex: 1
    }
  }) : null);
}
...
function CardScreen() {
  ...
  }, sc.num), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 26
    }
  }, /*#__PURE__*/React.createElement(Lines, {
...
const BARE = typeof location !== 'undefined' && new URLSearchParams(location.search).get('bare') === '1';
function SudesteVideo2() {
  ...
  const children = {};
  scenes.forEach(sc => {
    children[sc.name] = LAYOUTS[sc.layout] || TealScreen;
  });
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SceneStage, {
    ...
    transition: "cut",
    controls: !BARE
  }, children), !BARE && /*#__PURE__*/React.createElement(TweaksPanel, null, /*#__PURE__*/React.createElement(TweakSection, {
    label: "V\xEDdeo"

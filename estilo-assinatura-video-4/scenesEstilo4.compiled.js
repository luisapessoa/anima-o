...
function KbbContent({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, RUNTIME.showLogo ? /*#__PURE__*/React.createElement(Logo, {
    variant: "dark",
    lt: lt
  }) : null, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      ...
      top: 473 + 458 * slide,
      width: 10,
      height: 381 - 210 * slide,
      borderRadius: 3,
      background: BLUE,
      opacity: thickIn,
      transform: `scaleY(${thickIn})`,
      transformOrigin: 'top'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, body.map((ln, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...rise(lt, 0.45 + i * 0.09, 16),
      color: NAVY,
      ...light
    }
  }, ln))), /*#__PURE__*/React.createElement("div", {
  ...
  }, hi.map((ln, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...rise(lt, 1.95 + i * 0.1, 16),
      color: BLUE,
      fontWeight: 700,
      fontSize: 54,
      lineHeight: '65px',
    ...
    src: "assets/estilo/car-tera-12.webp",
    alt: "Volkswagen Tera",
    style: {
      position: 'absolute',
      left: -130,
      ...
      height: 'auto',
      opacity: carIn,
      transform: `translateX(${(1 - car) * 180}px)`
    }
  }));
}
function Kbb() {
  ...
  }, /*#__PURE__*/React.createElement(KbbContent, {
    sc: s.scene,
    lt: s.localTime
  }));
}
...
function Panel() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: H,
      background: WHITE,
      borderRadius: `${PANEL_R * m}px ${PANEL_R * m}px 0 0`,
      overflow: 'hidden'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, (sc.body2 || []).map((ln, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...rise(lt, t0 + 0.75 + i * 0.1, 16),
      color: NAVY,
      ...light
    }
  ...
  }, " ", sc.hi[0]) : null)), (sc.hi || []).slice(1).map((ln, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...rise(lt, t0 + 0.95 + i * 0.1, 16),
      color: BLUE,
      ...light,
      fontWeight: 700
    }
...
function Checklist() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        opacity: ease(lt, d + 0.05, 0.5),
        transform: `translateX(${(1 - ease(lt, d + 0.05, 0.6)) * 30}px)`
      }
    }, it.map((ln, j) => /*#__PURE__*/React.createElement("div", {
      key: j,
      style: {
        color: WHITE,
        ...light
...
function Divider() {
  ...
  }), /*#__PURE__*/React.createElement("div", null, (sc.body2 || []).map((ln, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...rise(lt, 2.0 + i * 0.1, 16),
      color: NAVY,
      ...light
    }
  }, ln))))));
...
const PRELOAD = ['assets/estilo/opt-logo-white.png', 'assets/estilo/opt-logo-dark.png', 'assets/estilo/car-tera-12.webp'];
